...
INFO = "ResNet Mobile Deep: 12 separable conv layers with skip connections"
...
class Net(nn.Module):
    def __init__(self, embedding_size=512):
        ...
        self.features = nn.Sequential(
            ...
            # Stage 1
            SeparableResBlock(64, 64),
            SeparableResBlock(64, 128, downsample=True),  # -> 28
            
            # Stage 2
            SeparableResBlock(128, 128),
            SeparableResBlock(128, 256, downsample=True), # -> 14
            
            # Stage 3
            SeparableResBlock(256, 256),
            SeparableResBlock(256, 512, downsample=True), # -> 7
            
            # Stage 4
            SeparableResBlock(512, 512),
        )
